"""CRISPRCasdb evidence reuse from GENOME-ATLAS (GENOME-ATLAS v0.6.0).

GENOME-ATLAS already ingested CRISPRCasdb April 2026 snapshot into two Parquet files:
...
def main(
    ...
    # 'uniprot_accession' in the GENOME-ATLAS deposit (not 'uniprot_acc').
    ...
    if len(is621_rows):
        ...
        print("IS621 composite case: DSB_FREE_TRANSEST_RECOMBINASE, composite=True [OK]")
