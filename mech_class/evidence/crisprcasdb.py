...
PROTEIN_MAP: dict[tuple[str, str], tuple[str, str, bool, float]] = {
    ...
    ("IS621_bridge_recombinase", "IS621_recombinase"): (
        "DSB_FREE_TRANSEST_RECOMBINASE", "B3_Programmable_Recombinase", True, 0.9,
    ),
...
def main(
    ...
    print(f"CRISPRCasdb proteins parquet: {len(proteins):,} rows, "
          f"columns={list(proteins.columns)}")
