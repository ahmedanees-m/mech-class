...
models/lightgbm_clf.py ablation). This implements the GENOME-ATLAS caveat.
"""
...
def load_structure_tokens(pdb_path: Path) -> str:
    ...
    Requires Foldseek binary in PATH (installed in the structure Docker image (containers/structure/)).
...
def build_struct_feature_matrix(
    ...
    """Build N x 1280 SaProt feature matrix.

    Returns
    -------
    matrix : np.ndarray
        N x 1280 embedding matrix.
