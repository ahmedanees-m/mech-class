"""Smoke test: verify genome-atlas is importable and Paper 1 artifacts load.
...
assert is621["mechanism_bucket"] == "DSB_FREE_TRANSEST_RECOMBINASE", (
    ...
    f"'DSB_FREE_TRANSEST_RECOMBINASE' (Paper 1 correction)"
)
print(f"  IS621 composite case: mechanism_bucket = {is621['mechanism_bucket']} ✓")
...
print("\n=== All checks passed. Paper 1 artifacts accessible. mech-class can build. ===")
