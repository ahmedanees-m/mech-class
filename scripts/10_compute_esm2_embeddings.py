"""Verify ESM-2 embeddings are available from GENOME-ATLAS.

ESM-2 150M (640-dim) embeddings were computed in GENOME-ATLAS and stored in
...
If gaps exist (new accessions not in GENOME-ATLAS atlas), they are written to
...
def run() -> None:
    ...
    # Load GENOME-ATLAS ESM-2 embeddings (column 'accession' in this parquet)
