"""SaProt features for Bxb1 (O25753) + Tier-A re-prediction.
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if not af_ok:
            ...
            if result["fixed_by_struct"]:
                print("  [PASS] STRUCT FIXES MISCLASSIFICATION - DSB_FREE_TRANSEST_RECOMBINASE")
            else:
                print("  [FAIL] STILL MISCLASSIFIED - document as model limitation")
