"""Step 18c -- Corrected holdout validation with Q9B086 (actual Bxb1 integrase).
...
PROBES = [
    ...
    },
    {
        ...
        "expected_tier_b":  None,   # Tier-B UNKNOWN = acceptable per §0.5
...
def run():
    ...
    for probe in PROBES:
        ...
        # Tier-B: UNKNOWN is always acceptable per §0.5
    ...
    print()
    print("Notes:")
    print("  * Tier-B UNKNOWN = acceptable (ungated per §0.5); Tier-B model has < 3")
    ...
    summary = {
        ...
        "probes":    results,
        "notes": {
            "tier_b_policy":   "UNKNOWN = acceptable (ungated per §0.5)",
    ...
    table_lines += [
        ...
        "",
        "Footnotes:",
        "  a Tier-B = UNKNOWN is acceptable (ungated, §0.5); small training N prevents sub-class discrimination.",
