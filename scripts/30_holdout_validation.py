"""Holdout validation on five pre-registered probe proteins.
...
PROBES = [
    ...
    },
    {
        ...
        "note":               "IN TRAINING (row 8658, PF00589). Not OOD -- included for composite FP table (pre-registration). Composite P=0.005 -> TN.",
    },
]
...
def run() -> None:
    ...
    # Composite FP summary (all 4 probes: Cas9/Bxb1/Cre/Tn5 -- Cre included per the pre-registration)
