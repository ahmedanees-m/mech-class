...
These tests run against a trained model on the VM. They are skipped locally
...
pytestmark = pytest.mark.skipif(
    ...
    reason="Trained model not found at /data/models/tier_a/model.pkl -- run on VM after training",
)
