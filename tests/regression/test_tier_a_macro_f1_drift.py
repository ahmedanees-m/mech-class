...
Pre-registered success criterion (from holdout_set.yaml pre-registration):
...
Paths (Docker volume layout):
  /data/features/feature_matrix.parquet  - training features (N x 1953 float32)
...
pytestmark = pytest.mark.skipif(
    ...
    reason=("Tier-A model or feature matrix not found at /data/models and /data/features - run after training"),
)
