...
Tests cover the pure-function helpers in api.py:
  ...
  _download_from_zenodo() — stub that raises RuntimeError (Zenodo not yet live)
...
class TestDownloadFromZenodo:
    def test_raises_runtime_error(self, tmp_path):
        """_download_from_zenodo is a stub that must raise RuntimeError."""
